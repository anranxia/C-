...
BEGIN_MESSAGE_MAP(CRemoteClientDlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_BUTTON_FILEINFO, &CRemoteClientDlg::OnBnClickedButtonFileinfo)//WM_COMMAND
...
void CRemoteClientDlg::UpdateFileInfo(const FILEINFO& finfo, HTREEITEM hParent)
{
	...
	if (finfo.IsDirectory) {
		...
		TRACE("hselected %08X/r/n", hParent);
...
void CRemoteClientDlg::LoadFileInfo()
{
	...
	CClientController::getInstance()->SendCommandPacket(GetSafeHwnd(), 2, false, (BYTE*)(LPCSTR)strPath,
