...
//bool CClientSocket::SendPacket(const CPacket& pack, std::list<CPacket>& lstPackets, bool isAutoClosed)
//{
...
//	}
//	m_lock.lock();
//	auto pr = m_mapAck.insert(std::pair<HANDLE, std::list<CPacket>&>(pack.hEvent, lstPackets));
...
//						if (size > 0) {//TODO:文件夹信息获取，文件信息获取可能产生问题
